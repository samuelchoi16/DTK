	...
	Uint16 bytesPerSample)
{
	...
	if (result.good()) {
		if (l_image->numcomps == 3) {
			Sint32* rPos = (Sint32*)(l_image->comps[0].data);
			Sint32* gPos = (Sint32*)(l_image->comps[1].data);
			Sint32* bPos = (Sint32*)(l_image->comps[2].data);
			...
			Sint32* iPos = (Sint32*)(l_image->comps[0].data);
