...
// JPEG 2000 library (CharLS) includes
//#include "intrface.h"
...
/*	JlsParameters jls_params;
	...
	{
		DCMJP2K_DEBUG("Converting image from " << (ilv == ILV_NONE ? "color-by-plane" : "color-by-pixel")
...
OFCondition DJP2KEncoderBase::losslessCookedEncode(
	const Uint16 *pixelData,
	const Uint32 length,
	DcmItem *dataset,
	const DJP2KRepresentationParameter *djrp,
...
OFCondition DJP2KEncoderBase::compressCookedFrame(
	DcmPixelSequence *pixelSequence,
	DicomImage *dimage,
	const OFString& /* photometricInterpretation */,
	DcmOffsetList &offsetList,
...
OFCondition DJP2KEncoderBase::convertToSampleInterleaved(
	Uint8 *target,
	const Uint8 *source,
	Uint16 components,
	Uint32 width,
